   ...
   public class ChaincoinMain : Network
   {
      public ChaincoinMain()
      {
         ...
         NetworkSetup network = ChaincoinSetup.Instance.Main;
            ...
            this.DefaultConfigFilename = setup.ConfigFileName; // The default name used for the Chaincoin configuration file.
         ...
         var consensusOptions = new ConsensusOptions
         {
            ...
            MaxStandardVersion = 3,
            MaxStandardTxWeight = 4_000_000,
        ...
        var bip9Deployments = new ChaincoinBIP9Deployments()
        {
            ...
            consensusFactory.Protocol = new ConsensusProtocol()
         {
            ...
            this.Consensus = new ChaincoinConsensus(
            ...
            this.Base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { (4) };
            ...
            this.StandardScriptsRegistry = new ChaincoinStandardScriptsRegistry();
