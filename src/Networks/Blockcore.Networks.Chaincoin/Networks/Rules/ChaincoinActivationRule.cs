...
namespace Blockcore.Networks.Rules
{
    ...
    public class ChaincoinActivationRule : HeaderValidationConsensusRule
    {
        ...
        public override void Run(RuleContext context)
        {
            ...
            //if (((header.Version < 2) && (height >= Parent.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP34])) ||
            //    ((header.Version < 3) && (height >= Parent.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP66])) ||
            //    ((header.Version < 4) && (height >= Parent.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP65])))
            //{
