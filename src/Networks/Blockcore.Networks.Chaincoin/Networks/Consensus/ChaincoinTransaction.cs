...
namespace Chaincoin.Networks.Consensus
{
   public class ChaincoinTransaction : Transaction
   {
      ...
      public override void ReadWrite(BitcoinStream stream)
      {
         ...
         //if (DashVersion != LastVersion)
         //{
         //   LastVersion = DashVersion;
         //   Blockcore.Consensus.BlockInfo.BlockHeader x = ChaincoinConsensusFactory.CurrentBlockHeader;
         //}

         //if (DashVersion == 2 && DashType != DashTransactionType.StandardTransaction)
         //{
